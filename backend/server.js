...
// --- Importação das Rotas do MVP (Música ao Vivo e Feeds) ---
const artistRoutes = require('./routes/artistRoutes');
const placeRoutes = require('./routes/placeRoutes');
const scheduleRoutes = require('./routes/scheduleRoutes');
const venueRoutes = require('./routes/venueRoutes'); // <-- Rota de importação do Instagram oEmbed
...
app.use('/api/venues', venueRoutes); // <-- Registro da nova rota de programação dos locais
